...
const OrderTable = () => {
  ...
  const columns: readonly Column[] = [
    { id: "id", label: t("id"), minWidth: 50, align: "center" },
    { id: "Client", label: t("client"), minWidth: 100, align: "center" },
    { id: "Reader", label: t("reader"), minWidth: 100, align: "center" },
    { id: "Date", label: t("date"), minWidth: 100, align: "center" },
    { id: "Time", label: t("time"), minWidth: 100, align: "center" },
    { id: "Actions", label: t("actions"), minWidth: 100, align: "center" },
  ];
